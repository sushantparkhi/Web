...
if (!empty($_POST)) {
    ...
    $query = " SELECT * FROM user_new WHERE email=:email";
    ...
    $query = "INSERT INTO user_new( name,contact_no,email,dob,city,gender,password) VALUES ( :name,:contact_no,:email,:dob,:city,:gender,:password) ";
