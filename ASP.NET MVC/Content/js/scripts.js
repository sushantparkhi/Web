...
$("#submit_btn").click(function () {
    ...
    if (proceed) {
        ...
        post_data,
        function (data) {
            $("#result").hide().html('<div class="success">' + "Enquiry Sent Successfully" + '</div>').fadeIn(700);
            $('#contact_form input').val('');
            $('#contact_form textarea').val('')
        }).fail(
            function (err) {
                $("#result").hide().html('<div class="error">' + "Something Went Wrong" + '</div>').fadeIn(1500)
            });
    }
});
...
var Chulan = new google.maps.LatLng(22.7168398, 75.9016824);
function initialize() {
    var styles = [
 {
     featureType: 'water',
    ...
    var companyImage = new google.maps.MarkerImage('/Content/images/marker.png',
    ...
    var companyPos = new google.maps.LatLng(22.7168398, 75.9016824);
